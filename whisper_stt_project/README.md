...
2. **Audio visualisation** — waveform, mel-spectrogram, MFCC heatmap and
   zero-crossing-rate plot.
3. **Compression / decompression** between WAV, FLAC, MP3 and OGG with
   compression-ratio reporting and round-trip quality (PSNR, RMSE) checks.
4. A single CLI driver (`src/main.py`) ties everything together and produces
